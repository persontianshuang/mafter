...
class Video:
    def create(self,name,mp4_url=''):
        ...
        sub_list= Subs.objects(name = new_flow.name)
...
# Video().create('言叶之庭','http://oqyvocafw.bkt.clouddn.com/longvacation/1.mp4')
# 鲁邦三世VS柯南  路人女主第二季03 徒然喜欢你03  longvacation1
# for x in Sentences.objects(flow_name = '言叶之庭'):
#
#     bs = 'http://oum9zyri9.bkt.clouddn.com/kodoba/{}.mp4'
#
#     x.split_mp4_url = bs.format(str(x.flow_id))
#     x.save()
# 图片
# for x in Flow.objects(name = '言叶之庭'):
#     x.img = 'http://outka3xht.bkt.clouddn.com/kodoba.jpg'
#     x.save()
